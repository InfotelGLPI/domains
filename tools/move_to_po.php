...
if (!is_readable(GLPI_ROOT . "/plugins/domains/locales/" . $_GET['lang'] . ".php")) {
...
$lf_new = fopen(GLPI_ROOT . "/plugins/domains/locales/temp.php", "w+");
...
$pot = fopen(GLPI_ROOT . "/plugins/domains/locales/glpi.pot", READ);
$po = fopen(GLPI_ROOT . "/plugins/domains/locales/" . $_GET['lang'] . ".po", "w+");
