ALTER TABLE `glpi_plugin_domain`
  RENAME `glpi_plugin_domains_domains`;
ALTER TABLE `glpi_plugin_domain_device`
  RENAME `glpi_plugin_domains_domains_items`;
ALTER TABLE `glpi_dropdown_plugin_domain_type`
  RENAME `glpi_plugin_domains_domaintypes`;
ALTER TABLE `glpi_plugin_domain_profiles`
  RENAME `glpi_plugin_domains_profiles`;
ALTER TABLE `glpi_plugin_domain_config`
  RENAME `glpi_plugin_domains_configs`;
...
COLLATE utf8_unicode_ci DEFAULT NULL,
  CHANGE `type` `plugin_domains_domaintypes_id` INT(11) NOT NULL DEFAULT '0'
...
COMMENT 'RELATION to glpi_suppliers (id)',
  CHANGE `others` `others` VARCHAR(255)
COLLATE utf8_unicode_ci DEFAULT NULL,
...
VALUES (NULL, 'Alert Domains', 'PluginDomainsDomain', '2010-02-24 21:34:46', '', NULL);